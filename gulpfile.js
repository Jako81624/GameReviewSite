...
elixir(function(mix) {
     mix.styles(['bootstrap.css', 'dropzone.css', 'bootstrap-markdown.min.css', 'main.css', 'fonts.css'])
        .scripts(['jquery-2.1.4.min.js', 'bootstrap.js', 'jquery.easing.min.js', 'scrolling-nav.js', 'bootbox.js', 'to-markdown.js', 'markdown.js', 'bootstrap-markdown.js', 'dropzone.js', 'modal.js', 'app.js'])
