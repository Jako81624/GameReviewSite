...
@section('content')
    ...
    <div id="featured" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <a href="/games/{{$ads->slug}}" id="spannedimage" style="height: 100%; width: 100%; display: block;">
            <div class="item ad1 @if($key == 0) active @endif " style="background: url({{$ads->temporary_jumbo_image}}) no-repeat center center fixed; height: 94vh">
                ...
                <a href="/games/{{$ads->slug}}" style="color:inherit"><h1 style="display: block;">{{$ads->title}}</h1></a>
                <p style="display: block">{{$ads->titletext}}</p>
